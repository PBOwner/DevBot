...
class ModSettings(MixinMeta):
    ...
    async def deletenames(self, ctx: commands.Context, confirmation: bool = False) -> None:
        """Delete all stored usernames, display names, and nicknames.

        Examples:
        - `[p]modset deletenames` - Did not confirm. Shows the help message.
        - `[p]modset deletenames yes` - Deletes all stored usernames, display names, and nicknames.
        ...
        **Arguments**
        ...
        if not confirmation:
            await ctx.send(
                _(
                    "This will delete all stored usernames, display names, and nicknames "
        ...
        async with ctx.typing():
            ...
            # Username and display name data
        ...
        await ctx.send(
            _("Usernames, display names, and nicknames have been deleted from Mod config.")
        )
